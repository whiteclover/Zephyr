...
CREATE TABLE `users` (
	...
	`secure_pass` CHAR(56) NOT NULL,
  `secure_salt` CHAR(44) NOT NULL,
	`bio` text NOT NULL,
...
INSERT INTO `users` VALUES (1,'zephyr','Zephyr','zephyr@demo.com', '363dd88e47a7fed07a3c6e8d0f08575f9500964ffc4c8ebc7394a7fe', 'KwyA/4mSTieZ8wL4kO6si48j5NZ7EkilqdUGQe0CH5s=','','active','root');
...
INSERT INTO `posts` VALUES (1,'Hello Zephyr','hello-Zephyr','','Hello Zephyr!!!','','','2015-03-09 19:56:09','2015-03-09 19:55:05',1,1,'published',0),(2,'clover','clover','','**It was a buried memory.**\r\n\r\n**It was an eternal oath.**\r\n\r\n**It was a wish from the heart.**\r\n\r\n**It was a regret kept for eternity.**','','','2015-03-09 19:57:20','2015-03-09 19:55:45',1,1,'published',1);
...
INSERT INTO `comments` VALUES (1,2,'approved','Zephyr','zephyr@demo.com','This a Test :)','2015-03-09 19:57:46');
...
INSERT INTO `storage` VALUES ('system','{\"auto_published_comments\": true, \"comment_moderation_keys\": [], \"comment_notifications\": false, \"description\": \"Zephyr is a Blog system\", \"posts_per_page\": 10, \"site_page\": 0, \"sitename\": \"Zephyr\"}');
